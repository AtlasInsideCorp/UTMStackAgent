                        ...
                        r.validate().then(function (r) {
                            "Valid" == r
                                ? (t.setAttribute("data-kt-indicator", "on"),
                                    (t.disabled = !0),
                                    createPassword(e.querySelector('[name="password"]').value)
                                )
                                : function () { }
                        });
                }),
    ...
    function createPassword(password) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                Swal.fire({
                    text: "You have successfully set your password!",
                    icon: "success",
                    buttonsStyling: !1,
